...
if (fs.existsSync('../../package.json')) {
  ...
  packageData.scripts['nanobox-start'] = 'DATA_POSTGRES_NAME=gonano GOOGLE_APPLICATION_CREDENTIALS=./storage/gapi_key.json node index.js > ./storage/last_cms_log.log'
