...
if (!initialized) {
  ...
  fs.copyFileSync('./src/components/UserDefinedViewsLinks.template.vue', '../../cms/CustomRoutes.vue')
...
fs.symlinkSync('../../../../cms/CustomRoutes.vue', './src/components/UserDefinedViewsLinks.vue')
